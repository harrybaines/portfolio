...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full bg-white text-neutral-900 overflow-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-20 py-3 px-5 md:px-7 backdrop-blur-sm border-b border-neutral-100">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.4 }}
            className="font-mono text-xs text-neutral-500 flex items-center"
          >
