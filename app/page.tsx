      ...
      <div className="container mx-auto h-full">
        ...
        <div className="flex flex-col xl:flex-row items-center justify-between mb-4 xl:pt-8">
          <div className="text-center max-w-4xl xl:text-left">
            {/* Available for work */}
            <Badge className="text-green-700 bg-green-100 mb-6 animate-from-bottom" style={{ "--index": 0 } as React.CSSProperties}>
            ...
            {/* Subheading */}
            <p className="text-lg text-gray-500 mb-2 animate-from-bottom">
              Software Engineer
            </p>
            {/* Name */}
            {/* <motion.div
            ...
            > */}
            <p className="text-4xl mb-8 font-semibold animate-from-bottom">
              Harry Baines
            </p>
            {/* </motion.div> */}
            <p className=" dark:text-white/80 animate-from-bottom" style={{ "--index": 1 } as React.CSSProperties}>
              Full-stack software engineer from the 🇬🇧 <span className="font-semibold">UK</span>. I specialise
              ...
              work with <span className="font-semibold">Next.js</span>, <span className="font-semibold">TypeScript</span> and <span className="font-semibold">Python</span>. I also enjoy contributing to
              open source (
              <a
                href={"https://unify.ai/"}
        ...
        {/* Links */}
        <div className="flex items-center gap-6 mb-8 text-sm animate-from-bottom" style={{ "--index": 1 } as React.CSSProperties}>
